...
import com.phono.rtp.RTPDataSink;
import com.phono.rtp.RTPProtocolFace;
import com.phono.rtp.RTPProtocolImpl;
import com.phono.rtp.SRTPProtocolImpl;
...
public class RTPAudioSession implements RTPDataSink {
    ...
    private void makePhonoAudioSrc(PhonoAudioShim a) {
        ...
        try {
            ...
            com.phono.android.audio.Log.error(ex.toString());
        }
        // receive side
