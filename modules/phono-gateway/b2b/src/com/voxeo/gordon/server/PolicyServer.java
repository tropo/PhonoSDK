...
/**
 * The PolicyServer waits for client connections and uses
 * PolicyServerConnections to handle policy requests.
 * 
...
public class PolicyServer extends Thread {
  ...
  public static final String POLICY_XML = "<?xml version=\"1.0\"?>" + "<cross-domain-policy>"
